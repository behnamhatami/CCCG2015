...
%For determining outliers, we just need to consider the points that may cause a transition so instead of exiting a node we ignore this point as an outlier.
% Sahand: Chi shode?
...
% behnam: man ba tarife kiana kheili moafegham
% sahand: done

...
we know by Lemma \ref{lem:B2dz} that $(\{c_2\} \cup \Buffer) \cap B_2^* \neq \emptyset$. 
Therefore, if $|B_2| \ge \dz$, then our candidates for $C$ are only $\{c_2\} \cup \Buffer$. 

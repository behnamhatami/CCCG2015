...
and gives a $\beta$-approximation to 1-center with $z$ outliers. %, for $k=0,\dots,z$.
...
The algorithm has $O(d^3z)$ space and $\poly(d,z)$ update time.
...
\begin{algorithmic}[1]
	...
	\STATE candidates $\gets \Buffer \cup B_2$
	\IF {$\card{B_2} \ge \dz$}

...
By our initial assumption about $p_1$ and  by invariants (c) and (d), if $c_p \in B_2^*$ 
we know that $B_1$ (resp., $B_2$) completely contains $B_1^*$  (resp., $B_2^*$).
%because $B_1 \cap B_2^* = \emptyset$ . 
But it might be the case that our assumption about $c_p$ 
was incorrect, and therefore, $B_1$ (resp., $B_2$) may not completely contain $B_1^*$ (resp., $B_2^*$). 
